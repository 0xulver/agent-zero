...
Examples:
  ...
  python run_query.py --customer-id 1234567890 --query "SELECT campaign.name, campaign.status FROM campaign" --format table

  # Get keyword data in JSON format
  python run_query.py --customer-id 1234567890 --query "SELECT ad_group_criterion.keyword.text FROM keyword_view" --format json

  # Save results to file
  python run_query.py --customer-id 1234567890 --query "SELECT campaign.name FROM campaign" --format csv --output results.csv
        """
    )
