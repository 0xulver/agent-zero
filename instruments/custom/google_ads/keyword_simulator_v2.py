...
Examples:
  ...
  python keyword_simulator_v2.py --customer-id 1234567890 --action simulate --keywords-file keywords.json

  # Analyze existing keyword competition
  python keyword_simulator_v2.py --customer-id 1234567890 --action competition --days 30

  # Find opportunity keywords
  python keyword_simulator_v2.py --customer-id 1234567890 --action opportunities --keywords-file keywords.json
        """
    )
